...
- **Certified** — this System can't be Audited by a System with lower Trust than its own. (Renamed from "Audited" so the keyword isn't confused with the Run an Audit action.) (Ethical AI Design flavor: a well-vetted system is hard to challenge unfairly.)
