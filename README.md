...
- **Print-and-play sheets**: `design/design-v1/tokens-print-page-*.png` (v1 card design, 7 pages, all 61 cards, sized for home printing at true 300 DPI — print at Actual Size / 100%)
